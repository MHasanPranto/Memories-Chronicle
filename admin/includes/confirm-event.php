              ...
              <div class="fields">
                ...
                <div class="event-date field">                
                  <input
                    ...
                    value="Enter event date"
                  />
                </div>
                <div class="tobepaid field">                
                  <input
                    type="number"
                    name="tobepaid"
                    class="name-input"
                ...
                <input type="hidden" name="c_msg_id" value="<?php echo $data['id']?>" />
                
              </div>
              <button class="signin-button" name="confirm">Confirm</button>
            </div>
          </form>
        </div>
        </div>
