...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,300;1,100&display=swap"
      rel="stylesheet"
    />
    <link
      rel="stylesheet"
  ...
  <body>
  <form action="./includes/validation.php" autocomplete="off" method="POST">
    <div class="login-div">
      <div class="logo"></div>
      <div class="title">Memories Chronicle</div>
      <div class="sub-title">Only Admin login with username and password</div>
      <div class="fields">
        ...
        <h5 style="color:crimson; text-align: center;"><?php if(isset($_GET['error'])){echo $_GET['error'];} ?></h5>
      </div>
